...
declare
  ...
  rpc_allowlist constant text[] := array['my_access', 'assign_membership', 'set_membership_status',
                                         ...
                                         'equity_reverse_payment', 'equity_cancel', 'equity_list', 'equity_detail',
                                         'equity_summary',
                                         -- P9 payroll (every one checks its own payroll.* capability; see 99_p9_*)
                                         'employee_create', 'employee_update', 'employee_end', 'employee_record_employment',
                                         'employee_set_compensation', 'employee_set_tax_profile', 'employee_set_bpjs',
                                         'employee_set_tax_opening', 'employee_list', 'employee_employment_history',
                                         'employee_compensation_get', 'employee_bpjs_get', 'employee_tax_profile_get',
                                         'employee_tax_identifier',
                                         'payroll_run_create', 'payroll_run_calculate', 'payroll_adjustment_add',
                                         'payroll_adjustment_remove', 'payroll_run_submit', 'payroll_run_return',
                                         'payroll_run_approve', 'payroll_run_discard', 'payroll_run_post', 'payroll_run_close',
                                         'payroll_run_reopen', 'payroll_run_correct', 'payroll_record_payment',
                                         'payroll_reverse_payment', 'payroll_run_list', 'payroll_run_get', 'payroll_run_lines',
                                         'payroll_adjustments_list', 'payroll_payments_list', 'payroll_payslip_list',
